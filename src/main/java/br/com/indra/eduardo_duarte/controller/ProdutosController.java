...
public class ProdutosController {
     ...
     * @return
     */
    @Operation(description = "Endpoint para retornar um produto pelo ID",
            summary = "Seleção de produto")
    @GetMapping("/{id}")
    ...
    //U
    @Operation(description = "Endpoint para atualizar um produto pelo ID",
    ...
    @Operation(description = "Endpoint para atualizar o preço do produto pelo ID",
            summary = "Atualização de preço do produto")
    ...
    @Operation(description = "Endpoint para deletar um produto pelo ID",
            summary = "Deletação de produto")
